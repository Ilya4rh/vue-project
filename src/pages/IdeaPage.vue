  ...
  * {
  ...
  .article-info {
    ...
    .idea-another-info {
      ...
      .idea-another-info__title__date{
        color: rgba(113, 86, 62, 1);
        font-family: Rubik;
        font-size: 12px;
        font-weight: 400;
        line-height: 14px;
